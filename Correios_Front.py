...
Numero_Linhas=3
Text_1=textpad.Textbox(curses.newwin(1,8,4,25), insert_mode=True)
Text_2=textpad.Textbox(curses.newwin(1,8,4,50), insert_mode=True)
Text_3=textpad.Textbox(curses.newwin(20,40,6,20), insert_mode=True)
Pulsacion=1
x=screen.getch()
...
while x!=27:
    if (x==9):
        if(Pulsacion==1):
            Text_1_Valor=Text_1.edit()
            Pulsacion=2
        if (Pulsacion==2):
            Text_2_Valor=Text_2.edit()
            Pulsacion=3
        if (Pulsacion==3):
            Text_3_Valor=Text_3.edit()
            Pulsacion=1
    x=screen.getch()
print (Text_1_Valor)
print (Text_2_Valor)
